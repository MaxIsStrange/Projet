...
if (isset($_SESSION['USER_FNAME'])) {
  echo $twig->render('tracker_ent.html.twig', ['cartes' => $cartes, 'msg' => $msg, 'limit' => $limit, 'i' => $i, 'visible1' => 'visibility: collapse', 'visiAdmin' => $_SESSION['ADMIN']]);
} else {
  echo $twig->render('tracker_ent.html.twig', ['cartes' => $cartes, 'msg' => $msg, 'limit' => $limit, 'i' => $i, 'visible2' => 'visibility: collapse', 'visiAdmin' => $_SESSION['ADMIN']]);
}
