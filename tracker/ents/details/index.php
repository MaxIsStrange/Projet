...
if (isset($_SESSION['USER_FNAME'])) {
  echo $twig->render('detail_ent.html.twig', ['id' => $id, 'result' => $result, 'album' => $album, 'adr' => $adr, 'visible1' => 'visibility: collapse', 'visiAdmin' => $visiAdmin]);
} else {
  echo $twig->render('detail_ent.html.twig', ['id' => $id, 'result' => $result, 'album' => $album, 'adr' => $adr, 'visible2' => 'visibility: collapse', 'visiAdmin' => $visiAdmin]);
}